...
export const why: Record<Locale, WhyContent> = {
  tr: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Açarsın, konunu çekersin, konuşursun, kapatırsın. Hepsi bu. Kodu açık; isteyen bakabilir, isteyen konu önerebilir.',
        ],
      },
    ],
    steps: {
    ...
    cta: { text: 'Okumak da bir çeşit kaydırma. Şimdi bir dakikanı ver.', button: 'Konumu çek' },
  ...
  en: {
    ...
    cta: { text: 'Reading is a kind of scrolling too. Now give it one minute.', button: 'Draw my topic' },
